...
///Field `SPI2RST` reader - SPI2S2 block reset Set and reset by software.
pub use TIM2RST_R as SPI2RST_R;
///Field `SPI3RST` reader - SPI2S3 block reset Set and reset by software.
...
///Field `I2C1_I3C1RST` reader - I2C1/I3C1 block reset Set and reset by software.
pub use TIM2RST_R as I2C1_I3C1RST_R;
...
///Field `HDMICECRST` reader - HDMI-CEC block reset Set and reset by software.
pub use TIM2RST_R as HDMICECRST_R;
...
///Field `SPI2RST` writer - SPI2S2 block reset Set and reset by software.
pub use TIM2RST_W as SPI2RST_W;
///Field `SPI3RST` writer - SPI2S3 block reset Set and reset by software.
...
///Field `I2C1_I3C1RST` writer - I2C1/I3C1 block reset Set and reset by software.
pub use TIM2RST_W as I2C1_I3C1RST_W;
...
///Field `HDMICECRST` writer - HDMI-CEC block reset Set and reset by software.
pub use TIM2RST_W as HDMICECRST_W;
...
impl R {
    ...
    #[inline(always)]
    pub fn hdmicecrst(&self) -> HDMICECRST_R {
        HDMICECRST_R::new(((self.bits >> 27) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APB1LRSTR")
            ...
            .field("hdmicecrst", &self.hdmicecrst())
...
impl W {
    ...
    ///Bit 21 - I2C1/I3C1 block reset Set and reset by software.
    #[inline(always)]
    pub fn i2c1_i3c1rst(&mut self) -> I2C1_I3C1RST_W<'_, APB1LRSTRrs> {
    ...
    ///Bit 27 - HDMI-CEC block reset Set and reset by software.
    #[inline(always)]
    pub fn hdmicecrst(&mut self) -> HDMICECRST_W<'_, APB1LRSTRrs> {
        HDMICECRST_W::new(self, 27)
    }
    ///Bit 30 - UART7 block reset Set and reset by software.
    #[inline(always)]
