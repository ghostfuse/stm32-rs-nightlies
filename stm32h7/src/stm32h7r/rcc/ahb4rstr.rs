...
///Field `GPIOMRST` reader - GPIOM block reset Set and reset by software.
pub use GPIOARST_R as GPIOMRST_R;
///Field `GPIONRST` reader - GPION block reset Set and reset by software.
pub use GPIOARST_R as GPIONRST_R;
///Field `GPIOORST` reader - GPIOO block reset Set and reset by software.
pub use GPIOARST_R as GPIOORST_R;
///Field `GPIOPRST` reader - GPIOP block reset Set and reset by software.
...
///Field `GPIOMRST` writer - GPIOM block reset Set and reset by software.
pub use GPIOARST_W as GPIOMRST_W;
///Field `GPIONRST` writer - GPION block reset Set and reset by software.
pub use GPIOARST_W as GPIONRST_W;
///Field `GPIOORST` writer - GPIOO block reset Set and reset by software.
pub use GPIOARST_W as GPIOORST_W;
///Field `GPIOPRST` writer - GPIOP block reset Set and reset by software.
