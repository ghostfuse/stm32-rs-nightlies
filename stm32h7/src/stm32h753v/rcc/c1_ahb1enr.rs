...
impl W {
    ...
    ///Bit 25 - USB1OTG Peripheral Clocks Enable
    #[inline(always)]
    pub fn usb1otgen(&mut self) -> USB1OTGEN_W<'_, C1_AHB1ENRrs> {
    ...
    ///Bit 27 - USB2OTG Peripheral Clocks Enable
    #[inline(always)]
    pub fn usb2otgen(&mut self) -> USB2OTGEN_W<'_, C1_AHB1ENRrs> {
        USB2OTGEN_W::new(self, 27)
    }
    ///Bit 28 - USB_PHY2 Clocks Enable
    #[inline(always)]
    pub fn usb2otgulpien(&mut self) -> USB2OTGULPIEN_W<'_, C1_AHB1ENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H753V.html#RCC:C1_AHB1ENR)*/
