...
impl W {
    ...
    ///Bit 27 - USB2OTG Peripheral Clocks Enable
    #[inline(always)]
    pub fn usb2otgen(&mut self) -> USB2OTGEN_W<'_, AHB1ENRrs> {
        USB2OTGEN_W::new(self, 27)
    }
    ///Bit 28 - USB_PHY2 Clocks Enable
    #[inline(always)]
    pub fn usb2otgulpien(&mut self) -> USB2OTGULPIEN_W<'_, AHB1ENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H753V.html#RCC:AHB1ENR)*/
