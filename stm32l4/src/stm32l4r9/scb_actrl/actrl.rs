...
impl W {
    ///Bit 0 - DISMCYCINT
    #[inline(always)]
    pub fn dismcycint(&mut self) -> DISMCYCINT_W<'_, ACTRLrs> {
        DISMCYCINT_W::new(self, 0)
    }
    ///Bit 1 - DISDEFWBUF
    #[inline(always)]
    pub fn disdefwbuf(&mut self) -> DISDEFWBUF_W<'_, ACTRLrs> {
    ...
    ///Bit 8 - DISFPCA
    #[inline(always)]
    pub fn disfpca(&mut self) -> DISFPCA_W<'_, ACTRLrs> {
        DISFPCA_W::new(self, 8)
    }
    ///Bit 9 - DISOOFP
    #[inline(always)]
    pub fn disoofp(&mut self) -> DISOOFP_W<'_, ACTRLrs> {
